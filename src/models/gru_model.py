...
Often achieves comparable performance with faster training.
"""
...
def build_model(input_shape):
    ...
    Architecture:
        Input → GRU(64) → Dense(32, ReLU) → Dense(1)
    ...
    model.compile(
        optimizer=GRU_PARAMS["optimizer"],
...
def train(X_train_seq, y_train_seq):
    """
    Scale data and train the GRU model.
